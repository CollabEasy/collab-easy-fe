...
import { fetchUserDataAction, FETCH_USER_DATA, setUserDataAction, updateArtistArtSuccess, updateArtistProfileAction, UPDATE_ARTIST_PROFILE } from 'state/action'
...
export const updateArtistProfileLogic = createLogic<
  AppState,
  FSACreatorPayload<typeof updateArtistProfileAction>,
  any,
  LogicDeps
>({
