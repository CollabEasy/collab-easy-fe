...
export const FETCH_CONTEST_SUBMISSION = 'FETCH_CONTEST_SUBMISSION';
export const FETCH_CONTEST_SUBMISSION_REQUEST = 'FETCH_CONTEST_SUBMISSION_REQUEST';
export const FETCH_CONTEST_SUBMISSION_SUCCESS = 'FETCH_CONTEST_SUBMISSION_SUCCESS';
export const FETCH_CONTEST_SUBMISSION_FAILURE = 'FETCH_CONTEST_SUBMISSION_FAILURE';
