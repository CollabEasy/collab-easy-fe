...
const mapStateToProps = (state: AppState) => ({
  ...
  isFetchingArtistSubmission:
    state.contestSubmission.isFetchingArtistSubmission,
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  ...
  uploadContestArtwork: (formData: FormData, contest: string) =>
    dispatch(actions.addContestArtwork(formData, contest)),
});
    ...
    <>
      {isFetchingArtistSubmission ? (
        ...
        <>
          ...
          {GetArtistSubmissionUrl(submissions.artistSubmission).length ===
            0 && (
            <>
              <p className="common-p-style" style={{ textAlign: "center" }}>
                You can submit only one art piece to this contest. Make sure
                this is your best and final work.
              </p>
              <Upload
                name="avatar"
          ...
          {GetArtistSubmissionUrl(submissions.artistSubmission).length > 0 && (
            <>
              <p className="common-p-style" style={{ textAlign: "center" }}>
                Thanks for submitting your work. It is now live for voting. So
                far, you have recieved{" "}
                <b>{getSubmissions(submissions.artistSubmission)} votes</b>.
                Spread the word and increase your chances of winning the
                contest!
              </p>
              <Image
