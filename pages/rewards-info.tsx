...
const RewardsInfoPage = ({
  ...
  return (
    <Layout
      ...
      name={"description"}
      content={
        "Learn how to earn reward points and redeem them for real money. Join Wondor now to start earning."
      }
    >
      <>
        <div className="rewardsInfoPage_listingPagecontainer">
          {windowWidth > 500 && <GenericBreadcrumb page={"Rewards Info"} />}
              ...
              <div className="col-sm-8" style={{ backgroundColor: "#D1C4E9" }}>
                <div className="rewardsInfoPage_desktopCoverTextContainer">
                  <h1 className="common-h1-style">
                    Earn rewards points for everything you do on Wondor, big or
                    small 😎
                  </h1>
                  <h3 className="common-h3-style">
                    Yes, we reward our amazing artists for being awesome members
                    of Wondor. These points can be redeemed for exclusive
                    prizes.
                  </h3>
                </div>
              </div>
                  ...
                  <div className="card border-hover-primary">
                    <div className="card-body">
                      ...
                      <p className="text-muted mb-0">
                        Create an account and enter code WONDOR-ART to earn 150
                        points.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col my-3">
                  <div className="card border-hover-primary hover-scale">
                    <div className="card-body">
                      ...
                      <p className="text-muted mb-0">
                        Refer your friends to wondor by
                        <Link
                        ...
                        and you both earn 150 points each.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col my-3">
                  <div className="card border-hover-primary hover-scale">
                    <div className="card-body">
                      ...
                      <p className="text-muted mb-0">
                        Complete your profile by adding bio, skills, samples,
                        and social accounts to earn 50 points.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col my-3">
                  <div className="card border-hover-primary hover-scale">
                    <div className="card-body">
                      ...
                      <p className="text-muted mb-0">
                        Collaborate with artists and all of the involved parties
                        get 50 points each for finishing a collaboration.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col my-3">
                  <div className="card border-hover-primary hover-scale">
                    <div className="card-body">
                      ...
                      <p className="text-muted mb-0">
                        Enter in out monthly contests to earn 50 points.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="rewardsInfo_container">
            <section className="bg-light-primary">
              ...
              <p>
                You can redeem your points for real money. In order to redeem,
                you have to have minimum of 1000 points. 1000 points = $10
              </p>
            </section>
          </div>
          <div className="row">
