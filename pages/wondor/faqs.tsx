...
const FAQs = ({ isLoggedIn, updateLoggedInData, loginModalDetails, user, artistListData, generalFaqContent }) => {
                    ...
                    <div className="row d-flex justify-content-center">
                        <div className="col-md-12" >
                            <Collapse ghost accordion>
                                {generalFaqContent.map((question, index) => (
...
export async function getStaticProps({ params }) {
    ...
    return { props: { generalFaqContent } }
}
