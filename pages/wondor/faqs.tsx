...
const FAQs = ({
  ...
  return (
    <Layout
      ...
      name={"description"}
      content={
        "We are happy to help you with any concern you may have or suggestions you would like to share. Here are some of the commanly asked questions. Contact us for any other question you may have."
      }
    >
      <div className="genericPageLayout_container">
        {windowWidth > 500 && (
          <GenericBreadcrumb page={"Frquently Asked Questions"} />
        )}
                    ...
                    <div className="faqCard">
                      <div className="faq-block faqCard-body">
                        <div className="container-fluid py-2">
                          <h5 className="common-h5-style f-19 mt-2 mb-2">
                            General Questions
                          </h5>
                          <div className="divider mb-2"> </div>
                        </div>
                        <div>{getfaqCard(generalFaqContent)}</div>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 grid-margin grid-margin-md-0">
                    <div className="faqCard">
                      <div className="faq-block faqCard-body">
                        ...
                        <div>{getfaqCard(contestFaqContent)}</div>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 grid-margin grid-margin-md-0">
                    <div className="faqCard">
                      <div className="faq-block faqCard-body">
                        ...
                        <div>{getfaqCard(inspirationHubFaqContent)}</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-12 grid-margin">
                    <div className="faqCard">
                      <div className="faq-block faqCard-body">
                        ...
                        <div>{getfaqCard(collaborationFaqContent)}</div>
                      </div>
                    </div>
                  </div>
                  <div className="col-12">
                    <div className="faqCard">
                      <div className="faq-block faqCard-body">
                        ...
                        <div>{getfaqCard(collaborationProposalFaqContent)}</div>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 grid-margin grid-margin-md-0">
                    <div className="faqCard">
                      <div className="faq-block faqCard-body">
                        ...
                        <div>{getfaqCard(securityAndAbuseFaqContent)}</div>
                      </div>
                    </div>
                  </div>
                </div>
