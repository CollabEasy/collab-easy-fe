    ...
    >
      ...
      <div className='genericPageLayout_container'>
        ...
        <div className="terms-privacy-policy-section-container">
          <GenericPageBanner
            heading="Wondor User Agreement"
            paragraph="This document outlines the terms of use of the Wondor website. If you have any questions about the terms of use, please contact us."
          />
